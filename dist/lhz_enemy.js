    ...
    constructor(label, num) {
        ...
        switch (num) {
            case 1:
                ...
                this._basicAttackTarget = Target.SINGLE;
                this._basicAttackRange = "至近";
            ...
            case 9:
                ...
                this._basicAttackRoleFix = 0;
                this._basicAttackRoleDice = 3;
                this._basicAttackTarget = Target.MULTI;
                this._basicAttackRange = "4Sq";
...
class EnemyUtils {
    static difficultyNormal(cr) {
        return EnemyUtils.difficulty.normal[cr];
    }
    static difficultyHard(cr) {
        return EnemyUtils.difficulty.hard[cr];
    }
    static difficultyVeryHard(cr) {
...
class EnemySkill {
     ...
     */
    static createBasicAttackSkill(type, range, target, avoidFix, avoidDice, damageFix, damageDice, isfix) {
...
class Enemy {
    ...
    */
    ...
    getSkills() {
        ...
        skills.push(EnemySkill.createBasicAttackSkill(this._type._basicAttackType, this._type._basicAttackRange, this._type._basicAttackTarget, this.getBasicAttackRole(), this._type._basicAttackRoleDice, this.getDamageFix(1), this.getDamageDice(), this._race === EnemyRace.GIMIC || this._rank === EnemyRank.MOB));
